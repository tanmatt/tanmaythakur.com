...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			'narrower':	{ range: '-960', href: '../static/css/style-narrower.css', containers: '100%', grid: { gutters: 20 } },
			'mobile':	{ range: '-736', href: '../static/css/style-mobile.css', containers: '100%!', grid: { collapse: true } }
		},
		plugins: {
			layers: {
				config: {
